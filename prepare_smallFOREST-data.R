...
colnames_transformations <- read.csv("./tick_abundance_2017_smallFOREST/intermediate data/colnames_transformations.csv")
...
main_patches <- read.csv("/home/steffen/Documents/git/Data Output/smallFOREST/FINAL_trans_wp2.csv")
grouping <- read.csv("./tick_abundance_2017_smallFOREST/intermediate data/grouping.csv")
